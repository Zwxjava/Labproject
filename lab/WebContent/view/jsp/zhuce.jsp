...
<script src="/Labproject/view/resourses/js/config/congfig.js"></script>
...
<body>
<form  action="/Labproject/zhuceServlet" method="post" >
...
<!-- 						密码：<input type="password" id="zpassword" name="zpassword" /> -->
...
<!-- 						<input type="submit"  id ="input_id_3" name="input_name_3" value="注册" /> -->
<!-- 					</div>		 -->
<!-- 				</div> -->
<!-- 			</div> -->
		<div class ="top">
				...
				<div class="login_con">
					<div class="login_form">
						<div class="login-form-title"> 
                           ...
                           <input type="submit"  id ="input_id_3" name="input_name_3" class="button-box" value="注册" />
                                </p>
                          </div>
                                <div class="login-form-warp">
                                <p>
                                   账号：<span id ="span_id" style ="color:red"></span><input type="text" id="text" name="zuser"/>
						
                                </p>
                                    <p>
         	密码：<span id ="span_id2" style ="color:red"></span><input type="password"  name="zpassword" />
						</p>
						       <p>
                                再次确认：<span id ="span_id1" style ="color:red"></span><input type="password"  name="rezpassword" />
						</p>
                                <p>
                                   密保 ：<span id ="span_id1" style ="color:red"></span><input type="text"  name="mibao1" />
						
                                </p>
                                <p>
			密保2：<span id ="span_id1" style ="color:red"></span><input type="text"  name="mibao2" />
